...
class WavepacketFFT : 
    ...
    def __init__( self, N=128, L=100., dt=0.1 ):
        ...
        # The potential V(x)
        self.V_0 = 1.5               # height of potential barrier
        self.V_width = 10.0          # width of potential barrier
        self.V_center = 0.75 * L   # center of potential barrier
        self.V_vel = -math.sqrt(2-1/(2*(L/10)**2)) #Initial velocity of potential
    ...
    def take_step(self):
        ...
        self.t += self.dt
        self.V_center += self.V_vel*self.dt
        #Also I need to update the exponential factors so everything propagates
        for j in range (self.N):
...
class Animator :
    ...
    def __init__(self, periodic=True,wavepacketFFT=None):
        ...
        self.myline1 = plt.axvline( x=(self.wavepacketFFT.V_center - 0.5 * self.wavepacketFFT.V_width)/ self.wavepacketFFT.dx,
                                   color='r'
            )
        self.myline2 = plt.axvline( x=(self.wavepacketFFT.V_center + 0.5 * self.wavepacketFFT.V_width)/ self.wavepacketFFT.dx,
                                   color='r'
            )
    ...
    def time_step(self):
        while True :
            ...
            print 'My potential is now at ' +str(self.wavepacketFFT.V_center)      
    ...
    def animate(self) :
        self.ani = animation.FuncAnimation( self.fig,        # Animate our figure
                                            ...
                                            interval=250,     # 50 ms between iterations
